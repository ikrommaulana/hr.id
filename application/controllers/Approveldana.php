...
class Approveldana extends CI_Controller {
    public function __construct(){
        ...
        $this->session->set_flashdata("halaman", "master"); //mensetting menuKepilih atau menu aktif
    ...
    public function index()
    {
        ...
        $data = array(
            ...
            'user' => $user,
            'data_approvel' =>$this->db->query("SELECT * FROM approvel_dana ORDER BY id_approvel DESC")->result()
        );
        $this->template->load('template','approvel/index',$data);
    }
