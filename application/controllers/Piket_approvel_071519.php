    ...
    function approve_pengajuan_piket($id_piket,$token){
        ...
        if(!$validasi){
                                ...
                                <table align='center' width='800px' cellpadding='0' cellspacing='1' bgcolor='#ffffff' border='0' style='font-family:Verdana,Geneva,Sans-serif;'>
                                    ...
                                    <tr>
                                        <td valign='top' colspan='3' style='padding-left:20px'>
                                            ...
                                            Kepada Yth, 
                                            ".$data_karyawan[0]->Title." ".$data_karyawan[0]->firstname."
                                            </p>
            ...
            if($cek_approver_dana){
                ...
                $get_email = $this->db->query("SELECT employee.*, division.division_name, jabatan.nama_jabatan FROM employee,division,jabatan WHERE employee.id_employee='$id_approver_dana' and employee.id_division = division.id_division and employee.id_position = jabatan.id_jabatan")->result();
                                ...
                                <table align='center' width='800px' cellpadding='0' cellspacing='1' bgcolor='#ffffff' border='0' style='font-family:Verdana,Geneva,Sans-serif;'>
                                    ...
                                    <tr>
                                        <td valign='top' colspan='3' style='padding-left:20px'>
                                            ...
                                            <p>".$get_email[0]->title." ".$get_email[0]->firstname."</p>
                                            <p>".$data_karyawan[0]->firstname." mengajukan dana piket : </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td valign='top' style='padding-left:20px'>
                                ...
                                <table align='center' width='800px' cellpadding='0' cellspacing='1' bgcolor='#ffffff' border='0' style='font-family:Verdana,Geneva,Sans-serif;'>
                                    ...
                                    <tr>
                                        <td valign='top' colspan='3' style='padding-left:20px'>
                                            ...
                                            <p>".$data_approver[0]->firstname." telah menyetujui pengajuan piket Anda</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td valign='top' style='padding-left:20px'>
                                ...
                                <table align='center' width='800px' cellpadding='0' cellspacing='1' bgcolor='#ffffff' border='0' style='font-family:Verdana,Geneva,Sans-serif;'>
                                    ...
                                    <tr>
                                        <td valign='top' colspan='3' style='padding-left:20px'>
                                            ...
                                            <p>".$data_approver[0]->firstname." menolak pengajuan piket Anda : </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td valign='top' style='padding-left:20px'>
                                ...
                                <table align='center' width='800px' cellpadding='0' cellspacing='1' bgcolor='#ffffff' border='0' style='font-family:Verdana,Geneva,Sans-serif;'>
                                    ...
                                    <tr>
                                        <td valign='top' colspan='3' style='padding-left:20px'>
                                            ...
                                            <p>".$data_approver[0]->firstname." telah menolak laporan piket Anda, silahkan buat kembali laporan piket agar pengajuan dana bisa diproses : </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td valign='top' style='padding-left:20px'>
