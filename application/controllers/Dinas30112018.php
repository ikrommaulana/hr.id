...
class Dinas extends CI_Controller {
    ...
    public function print_dana($id_dinas)
    {
        ...
        $div_nama = (empty($data_divisi)) ? '' : $data_divisi[0]->division_name;
    ...
    public function add_edit_data($id_dinas=''){
        ...
        if($id_jabatan==5 || $id_jabatan==11){
            /*$tot_hari_libur = 0;
            for($a=$start; $a<=$end; $a++){
                $cek_holiday = $this->db->query("SELECT * FROM hari_libur WHERE tanggal='$a'")->result();
                if($cek_holiday){
                    $libur = 1;
                }else{
                    $libur = 0;
                }
                $tot_hari_libur += $libur;
            }*/
            $cek_holiday = $this->db->query("SELECT * FROM hari_libur WHERE tanggal>='$start' AND tanggal<='$end'")->result();
            if ($cek_holiday) {
                $tot_hari_libur = count($cek_holiday);
            }else{
                $tot_hari_libur = 0;
            }
        }else{
        ...
        if($jml_data>0){
            ...
            if($id_division==4 && $id_jabatan>=5 ){ //finance staff
                $id_approver = '10050'; //CFO (irzan) ganti robin
            }if($id_division==4 && $id_jabatan==4 ){ //finance manajer
                $id_approver = '10007'; //CFO (irzan) ganti robin
            }elseif($id_division==16 || $id_jabatan==11){ //kharisma
                $id_approver = '10055'; //MARKO
            }elseif($id_division==0 || $id_jabatan==10){
                $id_approver = '10007'; //CEO (risha)
            }elseif($id_division==5 && $id_jabatan==4){ // hr manager
                $id_approver = '10055'; //marko
            }elseif($id_division==5 && $id_jabatan>=5){ // hr staff
                $id_approver = '10001'; //friska
            }elseif($id_division==12 && $id_jabatan==5){
                $id_approver = '10055'; //marko
            }elseif($id_division==7 && $id_jabatan==4){ //new 11-5-2017 league enterprise
                $id_approver = '10007'; //CEO (risha)
            }elseif($id_division==7 && $id_jabatan==5){ //new 11-5-2017 league enterprise
                $id_approver = '10024'; //rian 
            }elseif($id_division==10 && $id_jabatan==4){ //new 05-3-2018 media relation
                $id_approver = '10007'; //CEO (risha)
            }elseif($id_division==10 && $id_jabatan==5){ //new 05-3-2018 media relation
                $id_approver = '10044'; //CEO (risha)
            }elseif($id_division==3 && $id_jabatan==5){ //new 11-5-2017 marketing
                $id_approver = '10011'; //raphael
            }elseif($id_division==8 && $id_jabatan==5){ //new 11-5-2017 secretary division
                $id_approver = '10013'; //amalia
            }elseif($id_division==8 && $id_jabatan==10){ //new 11-5-2017 secretary division amalia
                $id_approver = '10007'; //CEO (risha)
            }elseif($id_division==6 && $id_jabatan==5){ //new 28-8-2018 competition
                $id_approver = '10012'; //asep
            }elseif($id_division==6 && $id_jabatan==4){ //new 28-8-2018 competition
                $id_approver = '10008'; //asep
            }elseif($id_division==2 && $id_jabatan==4){ //new 28-8-2018 competition
                $id_approver = '10055'; //asep
            }elseif($id_division==2 && $id_jabatan==5){ //new 28-8-2018 competition
                $id_approver = '10005'; //asep
            }elseif($id_division==11 && $id_jabatan==10){ //new 28-8-2018 competition
                $id_approver = '10055'; //viola
            }elseif($id_jabatan==9){//raphael
                $id_approver = '10007'; //pa tedi
            }else{
            ...
            if($id_dinas==''){
                ...
                if($level_jabatan_karyawan==1 && $id_division==7){  //new 11-5-2017 level staff divisi league enterprise
                    ...
                    $this->db->insert('dinas_approve_dana',$data_approver_dana4);   
                }elseif($id_division==11){ //new 5-11-2017 level manager kompetisi
                    //marco
                    $data_approver_dana2 = array(
                            'id_dinas'     => $new_id_dinas,
                            'id_approver'   => 10055
                    ...
                    $this->db->insert('dinas_approve_dana',$data_approver_dana4);   
                }elseif($level_jabatan_karyawan==3){ //level direktur
                    //teddy
                    /*$data_approver_dana2 = array(
                        'id_dinas'     => $new_id_dinas,
                        'id_approver'   => 10009
                ...
                if($data_approver){
                    ...
                    $email_approver = 'nurysmilee@gmail.com';
                }
                                    ...
                                    <table align='center' width='800px' cellpadding='0' cellspacing='1' bgcolor='#ffffff' border='0' style='font-family:Verdana,Geneva,Sans-serif;'>
                                        ...
                                        <tr>
                                            <td valign='top' colspan='3' style='padding-left:20px'>
                                                ...
                                                <p>".$data_karyawan[0]->firstname." mengajukan permohonan perjalanan dinas : </p>
                                            </td>
                                        </tr>
                                        <tr>
                ...
                $mail->Password = 'n0r3pl!EMAIL'; //password email 
                $mail->SMTPSecure = "ssl";
    ...
    function daftar_pengajuan(){
        ...
        $data_dinas = $this->db->query("SELECT * FROM dinas a, dinas_approve b, dinas_approve_dana c WHERE a.id_dinas=b.id_dinas AND a.id_dinas=c.id_dinas AND (b.id_approver='$user_id' OR c.id_approver='$user_id') group by a.id_dinas")->result();
