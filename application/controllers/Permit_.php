...
class Permit_ extends CI_Controller {
    ...
    function rekap(){
        ...
        $data_cuti = $this->db->query("SELECT a.id_permit,a.id_employee,a.total_days,a.reason,a.start_date,a.end_date,a.id_cuti,b.status,b.status_batal,a.created_date FROM permit a, permit_approve b, employee c WHERE a.id_permit=b.id_permit AND a.id_employee=c.id_employee group by a.id_permit order by c.firstname ASC")->result();
        //approved dana all
    ...
    function batal(){
        ...
        $data_permit2 = $this->db->query("SELECT * FROM permit WHERE id_permit='$id_permit'")->result();
        $jenis_cuti = $data_permit2[0]->id_cuti;
        $data_cuti = $this->db->query("SELECT * FROM cuti WHERE id_cuti='$jenis_cuti'")->result();
        $start = $data_permit2[0]->start_date;
        $end = $data_permit2[0]->end_date;
        $approver = $data_permit[0]->id_approver;
        $data_approver = $this->db->query("SELECT * FROM employee WHERE id_employee='$approver'")->result();
        $email_to = $data_approver[0]->email_test;
        $token = md5(date('Ymd h:i:s'));
        $data = array(
            'status_batal'    => 1,
            'batal_by'        => $user_id,
        ...
        $message = "<html>
                                ...
                                <table align='center' width='800px' cellpadding='0' cellspacing='1' bgcolor='#ffffff' border='0' style='font-family:Verdana,Geneva,Sans-serif;'>
                                    ...
                                    <tr>
                                        <td valign='top' colspan='2' style='padding-left:20px'>
                                            ...
                                            <p>".$data_karyawan[0]->firstname." mambatalkan izin/cuti :</p>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan='3'>: ".$data_permit2[0]->reason."</td>
                                    </tr>
                                    <tr>
                                        <td valign='top' style='padding-left:20px'>
                                            Jenis Pengajuan
                                    ...
                                    <tr>
                                        ...
                                        <td colspan='3'>: ".$this->input->post('alasan')."</td>
                                    </tr>
                                    <tr height='30'></tr>
                        ...
                        $mail->IsHTML(true);
                        $mail->Subject = 'Notifikasi pembatalan cuti/izin'; 
                        $mail->Body = $message; 
    ...
    public function add_edit_data($id_permit=''){
        ...
        $data_cuti_sama = $this->db->query("SELECT * FROM permit a, permit_approve b WHERE a.id_employee='$user_id' AND a.id_cuti='$id_cuti' AND a.id_permit=b.id_permit AND b.status_batal='0' AND b.status!='2' AND a.start_date<='$start' AND a.end_date>='$end'")->result();
            ...
            if($cek_hari_libur1=='Sat' || $cek_hari_libur1=='Sun' || $cek_hari_libur2=='Sat' || $cek_hari_libur2=='Sun'){
                ...
                echo ("<SCRIPT LANGUAGE='JavaScript'>
                    ...
                    if($start2 == 0){
                        ...
                        $get_approver = (empty($data_employee)) ? '' : $data_employee[0]->approver;
                        ...
                        $get_email = $this->db->query("SELECT * FROM employee WHERE id_employee='$id_approver'")->result();
                        if($get_email){
                            $email_to = $get_email[0]->email; 
                            $untuk = $get_email[0]->firstname;
                        }else{
                            $email_to ='nurysmilee@gmail.com';
                            $untuk = '';
                        }
                                ...
                                <table align='center' width='800px' cellpadding='0' cellspacing='1' bgcolor='#ffffff' border='0' style='font-family:Verdana,Geneva,Sans-serif;'>
                                    ...
                                    <tr>
                                        <td colspan='3' style='padding-left:20px'>
                                            <a href='".base_url()."permit_/approve_cuti_mail/".$new_id_permit."' class='button'>Setujui</a>
                                            <a href='".base_url()."permit_/tolak_cuti_mail/".$new_id_permit."' class='button2'>Tolak</a>
                                            <a href='".base_url()."permit_/history/".$user_id."' class='button3'>History</a>
                        ...
                        require_once("PHPMailer/PHPMailerAutoload.php");
                        $mail_hr = 'friska.ferdianty@ligaindonesiabaru.com';
                        $mail2 = new PHPMailer(); 
    ...
    function approve_batal_cuti_mail($id_permit,$token){
        $user_id = $this->session->userdata('user_id');
        $admin_role=$this->session->userdata('admin_role');
        $user_role_data = $this->db->query("SELECT * FROM privileges_status WHERE id_privileges='$admin_role'")->result();
        $cek_user = $this->db->query("SELECT * FROM administrator WHERE id_administrator='$user_id'")->result();
        ...
        $data_permit2 = $this->db->query("SELECT * FROM permit WHERE id_permit='$id_permit'")->result();
        $jenis_cuti = $data_permit2[0]->id_cuti;
        $id_karyawan = $data_permit2[0]->id_employee;
        $data_cuti = $this->db->query("SELECT * FROM cuti WHERE id_cuti='$jenis_cuti'")->result();
        $start = $data_permit2[0]->start_date;
        $end = $data_permit2[0]->end_date;
        $approver = $data_permit[0]->id_approver;
        ...
        $email_to = $data_karyawan[0]->email_test;
        $tanggal1 = strtotime($start); 
        $dt1 = date("d F Y  ", $tanggal1);
        $tanggal2 = strtotime($end); 
        $dt2 = date("d F Y  ", $tanggal2); 
        ...
        $message = "<html>
                                ...
                                <table align='center' width='800px' cellpadding='0' cellspacing='1' bgcolor='#ffffff' border='0' style='font-family:Verdana,Geneva,Sans-serif;'>
                                    ...
                                    <tr>
                                        <td valign='top' colspan='2' style='padding-left:20px'>
                                            ...
                                            <p>".$data_approver[0]->firstname." telah menyetujui permohonon pembatalan izin/cuti Anda:</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td valign='top' style='padding-left:20px'>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan='3'>: ".$data_permit[0]->alasan_batal."</td>
                                    </tr>
                                    <tr height='30'></tr>
                                    <tr height='30'></tr>
                                    <tr>
                        ...
                        $mail->Port = 465; //port secure ssl email 
                        $mail->IsHTML(true);
                        $mail->Subject = 'Persetujuan pembatalan cuti/izin'; 
                        $mail->Body = $message; 
                        $mail->AddAddress($email_to);
                        //$mail->AddBcc('idam@ligaindonesiabaru.com');
                        $mail->Send();
        ...
        if($this->db->affected_rows()!=0){
            redirect("permit_/approve_batal_status");
        }
    }

    function tolak_batal_cuti_mail($id_permit,$token){
        $user_id = $this->session->userdata('user_id');
        $admin_role=$this->session->userdata('admin_role');
        $user_role_data = $this->db->query("SELECT * FROM privileges_status WHERE id_privileges='$admin_role'")->result();
        $cek_user = $this->db->query("SELECT * FROM administrator WHERE id_administrator='$user_id'")->result();
        ...
        $message = "<html>
                                ...
                                <table align='center' width='800px' cellpadding='0' cellspacing='1' bgcolor='#ffffff' border='0' style='font-family:Verdana,Geneva,Sans-serif;'>
                                    ...
                                    <tr>
                                        <td valign='top' colspan='2' style='padding-left:20px'>
                                            ...
                                            <p>".$data_approver[0]->firstname." Menolak permohonon pembatalan izin/cuti Anda:</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td valign='top' style='padding-left:20px'>
                        ...
                        $mail->Port = 465; //port secure ssl email 
                        $mail->IsHTML(true);
                        $mail->Subject = 'Penolakan pembatalan cuti/izin'; 
                        $mail->Body = $message; 
                        $mail->AddAddress($email_to);
                        //$mail->AddBcc('idam@ligaindonesiabaru.com');
                        $mail->Send();
        ...
        if($this->db->affected_rows()!=0){
            redirect("permit_/unapprove_batal_status");
        }
    }
    ...
    function approve_batal_status(){
        $this->load->view('permit/approve_batal');
    }

    function unapprove_batal_status(){
        $this->load->view('permit/unapprove_batal');
    }
    ...
    function ganti_tanggal($id_permit){
        $data  = array(
            'end_date'    => '2018-08-01'
        );
        $this->db->where('id_permit', $id_permit);
    ...
    function update_status_batal($id_permit){
        $data  = array(
            'status_batal'    => 1,
        );
        $this->db->where('id_permit', $id_permit);
    ...
    function tambah_kolom_(){
        $this->db->query("ALTER TABLE permit_approve ADD token varchar (50)")->result();
    }
}