            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        ...
                        <ol class="breadcrumb">
                            <li><a href="javascript:void(0)">Absensi Saya</a></li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                            ...
                            <div class="table-responsive">
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        <?php $no=1;
                                            if($departemen==''){
                                                $data_kehadiran = $this->db->query("SELECT * FROM employee a, employee_absensi b WHERE a.id_employee='$id_user' and a.id_absensi=b.id_absensi AND b.absensi_date>='$tanggal_start' AND b.absensi_date<='$tanggal_end' GROUP BY CONCAT(a.firstname, '-', b.absensi_date) ASC")->result();
                                            }else{
                                                $data_kehadiran = $this->db->query("SELECT * FROM employee a, employee_absensi b WHERE a.id_employee='$id_user' and a.id_division='$departemen' AND a.id_absensi=b.id_absensi AND b.absensi_date>='$tanggal_start' AND b.absensi_date<='$tanggal_end' GROUP BY CONCAT(a.firstname, '-', b.absensi_date) ASC")->result();
                                            }
                                        ...
                                        <tr>
                                            ...
                                            <td><?php if($division_name!='-'){?><?=$division_name;?><?php }?></td>
                                        ...
                                        <?php 
                                            if($departemen==''){
                                                $data_izin = $this->db->query("SELECT * FROM employee a, permit b WHERE a.id_employee='$id_user' and  a.id_employee=b.id_employee AND b.start_date>='$tanggal_start' AND b.end_date<='$tanggal_end'")->result();
                                            }else{
                                                $data_izin = $this->db->query("SELECT * FROM employee a, permit b WHERE a.id_employee='$id_user' and  a.id_division='$departemen' AND a.id_employee=b.id_employee AND b.start_date>='$tanggal_start' AND b.end_date<='$tanggal_end'")->result();
                                            }
                                        ...
                                        <?php 
                                            if($departemen==''){
                                                $data_dinas = $this->db->query("SELECT * FROM employee a, dinas b,dinas_approve c WHERE a.id_employee='$id_user' and  a.id_employee=b.id_employee AND b.start_date>='$tanggal_start' AND b.end_date<='$tanggal_end' AND c.status='1' GROUP BY b.id_dinas")->result();
                                            }else{
                                                $data_dinas = $this->db->query("SELECT * FROM employee a, dinas b,dinas_approve c WHERE a.id_employee='$id_user' and  a.id_division='$departemen' AND a.id_employee=b.id_employee AND b.start_date>='$tanggal_start' AND b.end_date<='$tanggal_end' AND c.status='1' GROUP BY b.id_dinas")->result();
                                            }
