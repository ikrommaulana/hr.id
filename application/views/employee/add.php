                    ...
                    <div class="span12">
                        <div class="w-box">
                            <div class="w-box-header">
                                <h4>List Of Additional Information</h4>
                            </div>
                            <div class="w-box-content">
                                <table class="table table-vam table-striped" id="dt_gal">
                                    ...
                                    <tbody>
                                        <?php $no=1; foreach($data_add as $view){
                                        ?>
                                        <tr>
                                            <td><?=$view->attendance_date;?></td>
                                            <td><?=$view->description;?></td>
                                            <td>
                                                <div class="btn-group">
                                                <a href="<?=base_url()?>employee/add_hapus/<?=$view->id_attendance_add.'/'.$view->id_employee;?>" onclick="return confirm('Are you sure to delete data?')" class="btn btn-mini" title="Delete"><i class="icon-trash"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        <?php $no++;}?>
                        ...
                        <div class="modal-dialog" >
                            <div class="modal-content" style="height:auto ">
                                ...
                                <div class="modal-body form" style="background:#f1f1f1">
                                    <div class="col-sm-12">
                                    <form method="post" action="<?=base_url()?>employee/add_info" id="form" class="form-horizontal">
                                        <input type="hidden" name="id_employee" value="<?=$id_employee;?>">
                                        <div class="form-body" style="width:500px; margin:0 auto;">
                                            <div class="form-group">
                                                <label>Description</label>
                                                <div class="input-group description">
                                                    <select name="description" class="form-control description" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group" data-validate="email">
                                                    <input type="date" class="form-control meeting-date" id="datepicker" name="tanggal" required>
