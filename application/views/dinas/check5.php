            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        ...
                        <ol class="breadcrumb">
                            <li><a href="javascript:void(0)">Daftar Dinas</a></li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                        <form method="post" action="<?=base_url()?>dinas/rekap">
                            <div class="row">
                                ...
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>ID Jabatan</th>
                                            <th>ID Biaya Dinas Detail</th>
                                            <th>ID Biaya Dinas</th>
                                            <th>Biaya</th>
                                        </tr>
                                    </thead> 
                                    <tbody>
                                        <?php 
                                                $no=1; foreach($data_dinas as $view){
                                                ?>
                                        <tr>
                                            <td style="text-align:center"><?=$no;?></td>
                                            <td><?=$view->id_jabatan;?></td>
                                            <td><?=$view->id_biaya_dinas_detail;?></td>
                                            <td><?=$view->id_biaya_dinas;?></td>
                                            <td><?=$view->biaya;?></td>
                                            </tr>
                                        <?php $no++;}?>
                                    </tbody>
