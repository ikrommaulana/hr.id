            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        ...
                        <ol class="breadcrumb">
                            <li><a href="javascript:void(0)">Daftar dinas hari ini</a></li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                        ...
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        <?php $no=1; foreach($data_dinas_hari_ini as $view){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                <a href="<?=base_url()?>dinas/detail/<?=$view->id_dinas?>" class="btn btn-mini" title="Lihat Detail"><i class="icon-eye"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        <?php $no++;}?>
