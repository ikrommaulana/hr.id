                                    ...
                                    <div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="white-box p-l-20 p-r-20">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <form class="floating-labels" method="post" action="<?=base_url()?>dinas/add_edit_data/">
                                                        <div class="row">
                                                          ...
                                                          <div class="row">
                                                              <div class="form-group m-b-40 col-sm-6">
                                                                  <input class="form-control input-daterange-datepicker" type="text" id="input12" required name="tanggal" value=""/  onchange="return tgl();"><span class="highlight"></span> <span class="bar"></span>
                                                                  <label for="input12">Tanggal</label>
                                                              </div>
                                                              <div class="form-group m-b-40 col-sm-6">
                                                                  <input class="form-control" type="text" id="input13" required name="keperluan" value="" /><span class="highlight"></span> <span class="bar"></span>
                                                          ...
                                                          <div class="row">
                                                              <div class="form-group m-b-40 col-sm-6">
                                                                  ...
                                                                  <label for="input5">Jenis Perjalanan</label>
                                                              </div>
