                        ...
                        <div class="white-box" style="background-color: #999;">
                            ...
                            <div>
                                <div class="wizard-content" style="margin-bottom: -30px">
                                                              ...
                                                              <div class="white-box p-l-20 p-r-20">
                                                                  <div class="row">
                                                                      <div class="col-md-12">
                                                                          ...
                                                                          <div class="row">
                                                                              <h2 class="box-title m-b-0">Pengajuan Karyawan baru</h2><br>
                                                                          </div>
                                                                            <div class="row">
                                                                                <div class="col-sm-4">
                                                                                    <h5><b>Oleh</b></h5>
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <h5><?php 
                                                                                    $tanggal1 = strtotime($data_request[0]->created_date);$dt = date("d F Y  ", $tanggal1);
                                                                                    echo $dt;?></h5>
                                                                                </div>
                                                                                <div class="col-sm-4">
                                                                                </div>
                                                                  ...
                                                                  <div class="row">
                                                                      <div class="col-md-12">
                                                                          <div class="row">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-sm-4">
                                                                                    <h5><b>Jumlah Pengajuan Karyawan</b></h5>
                                                                                </div>
                                                                                <div class="col-sm-6">
                                                                                    <h5><?=$data_request[0]->recruit_total;?></h5>
                                                                                </div>
                                                                                <div class="col-sm-2">
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <h5><?=$data_request[0]->requirement;?></h5>
                                                                                </div>
                                                                                <div class="col-sm-4">
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-sm-4">
                                                                                    <h5><b>Status Kerja</b></h5>
                                                                                </div>
                                                                                <div class="col-sm-4">
                                                                                    <h5><?=$data_request[0]->status_kerja;?></h5>
                                                                                </div>
                                                                                <div class="col-sm-4">
                                                                                    <h5></h5>
                                                                                </div>
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <h5><?=number_format($data_request[0]->salary);?></h5>
                                                                                </div>
                                                                                <div class="col-sm-4">
                                                                                    <h5></h5>
                                                                                </div>
                                    ...
                                    <form method="post" action="<?=base_url()?>karyawan/approve_pengajuan/<?=$data_request[0]->id_recruitment_request;?>">
                                    <div class="row">
