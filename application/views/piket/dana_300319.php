     ...
     <body>
            <div class="container">
                ...
                <table border='1' style="font-size: 10px; <?php if(!$data_dir){?> margin-left: 135px<?php }?> <?php if($data_dir){if($data_dir[0]->id_employee==10009){?> margin-left: 135px<?php }}?> <?php if($data_dir){if($data_dir[0]->id_employee==10010){?> margin-left: 135px<?php }}?>">
                    ...
                    <tr>
                        <td style="width: 108px; padding: 10px">
                        ...
                        <?php }else{?>
                            <td style="width: 135px; padding: 10px">
                                <?php
                                    ...
                                    if($cek_approve3){
                                        //$get_sign = $this->db->query("SELECT sign_dig as sd FROM employee WHERE id_employee='10050'")->result();
                    ...
                    <tr>
                        ...
                        <?php }else{?>
                            <td style="width: 135px; padding: 10px; text-align: center;">Yulius Amos</td>
                        <?php }?>
                        <?php if($app_new==0){?>
