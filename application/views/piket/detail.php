                        ...
                        <div class="white-box" style="background-color: #999;">
                            ...
                            <div>
                                <div class="wizard-content" style="margin-bottom: -30px">
                                                              ...
                                                              <div class="white-box p-l-20 p-r-20">
                                                                  <div class="row">
                                                                      <div class="col-md-12">
                                                                          ...
                                                                          <div class="row">
                                                                              <h2 class="box-title m-b-0">Pengajuan Piket</h2><br>
                                                                          </div>
                                                                            <div class="row">
                                                                                <div class="col-sm-4">
                                                                                    <h5><b>Oleh</b></h5>
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <h5><?php 
                                                                                    $tanggal1 = strtotime($data_piket[0]->created_date);$dt = date("d F Y  ", $tanggal1);
                                                                                    echo $dt;?></h5>
                                                                                </div>
                                                                                <div class="col-sm-4">
                                                                                </div>
                                                                  ...
                                                                  <div class="row">
                                                                      <div class="col-md-12">
                                                                          <div class="row">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-sm-4">
                                                                                    <h5><b>Tanggal piket</b></h5>
                                                                                </div>
                                                                                <div class="col-sm-6">
                                                                                    <h5><?php 
                                                                                        $tanggal1 = strtotime($data_piket[0]->start_date);$dt = date("d F Y  ", $tanggal1);
                                                                                        $tanggal2 = strtotime($data_piket[0]->end_date);$dt2 = date("d F Y  ", $tanggal2);
                                                                                        echo $dt.' - '.$dt2;?></h5>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                    ...
                                    <form method="post" action="<?=base_url()?>piket/approve_pengajuan/<?=$data_piket[0]->id_piket;?>">
                                    <div class="row">
