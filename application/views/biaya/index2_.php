                                ...
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        <?php $no=1; foreach($data_biaya as $view){
                                            $data_detail = $this->db->query("SELECT * FROM biaya_dinas_detail WHERE id_biaya_dinas='$view->id_biaya_dinas' ORDER BY id_jabatan DESC")->result();
                                        ?>
                                        <tr>
                                            <td style="text-align:center"><?=$no;?></td>
                                            <td><?=$view->keterangan;?></td>
                                            <?php foreach($data_detail as $view){?>
                                            <td><?=$view->biaya;?></td>
                                            <?php }?>
                                            <td>
                                                <div class="btn-group">
