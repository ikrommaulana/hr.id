                        ...
                        <div class="white-box" style="background-color: #999;">
                            ...
                            <div>
                                <div class="wizard-content" style="margin-bottom: -30px">
                                                        ...
                                                        <div class="row">
                                                          <div class="col-sm-12">
                                                              <div class="white-box p-l-20 p-r-20">
                                                                  <div class="row">
                                                                      <div class="col-md-12">
                                                                          <form class="floating-labels" method="post" action="<?=base_url()?>permit_/add_edit_data/">
                                                                          
                                                                          <div class="row">
                                                                              <h2 class="box-title m-b-0">Pengajuan Cuti</h2><br>
                                                                          </div>
                                                                            <div class="row">
                                                                                <div class="col-sm-4">
                                                                                    <h5><b>Untuk</b></h5>
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <h5><?=$data_employee[0]->firstname;?></h5>
                                                                                </div>
                                                                                <div class="col-sm-4">
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <h5><?=$data_employee[0]->nama_jabatan;?></h5>
                                                                                </div>
                                                                                <div class="col-sm-4">
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <h5><?php 
                                                                                    $tanggal1 = strtotime($data_cuti[0]->created_date);$dt = date("d F Y  ", $tanggal1);
                                                                                    echo $dt;?></h5>
                                                                                </div>
                                                                                <div class="col-sm-4">
                                                                                </div>
                                                                  ...
                                                                  <div class="row">
                                                                      <div class="col-md-12">
                                                                          <div class="row">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-sm-4">
                                                                                    <h5><b>Tanggal Cuti</b></h5>
                                                                                </div>
                                                                                <div class="col-sm-6">
                                                                                    <h5><?php 
                                                                                      $tanggal1 = strtotime($data_cuti[0]->start_date);
                                                                                      $dt = date("d F Y  ", $tanggal1);
                                                                                      $tanggal2 = strtotime($data_cuti[0]->end_date);$dt2 = date("d F Y  ", $tanggal2);
                                                                                    echo $dt.' - '.$dt2;?></h5>
                                                                                </div>
                                                                                <div class="col-sm-2">
                                                                                </div>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-sm-4">
                                                                                    <h5><b>Keperluan Cuti</b></h5>
                                                                                </div>
                                                                                <div class="col-sm-4">
                                                                                    <h5><?=$data_cuti[0]->reason;?></h5>
                                                                                </div>
                                                                                <div class="col-sm-4">
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-sm-4">
                                                                                    <h5><b>Cuti Ditanggal Yang Sama</b></h5>
                                                                                </div>
                                                                                <div class="col-sm-4">
                                                                                <?php foreach($data_cuti_sama as $view){
                                                                                  $data_emp = $this->db->query("SELECT * FROM employee WHERE id_employee='$view->id_employee'")->result();
                                                                                  foreach($data_emp as $view2){
                                                                                  ?>
                                                                                    <h5><?=$view2->firstname;?></h5>
                                                                                <?php }}?>
                                                                                </div>
                                                                                <div class="col-sm-4">
                                                                                </div>
                                    ...
                                    <form method="post" action="<?=base_url()?>permit_/approve_cuti/<?=$data_cuti[0]->id_permit;?>">
                                    <div class="row">
